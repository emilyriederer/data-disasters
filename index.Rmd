...
url: data-disasters.netlify.app
---
...
lapply(c('xfun','dplyr','ggplot2','DBI'), function(pkg) {
...
This book is built by the excelent **bookdown** R package with styling tips heavily inspired by the [Tidy Maching Leaning with R](https://github.com/tidymodels/TMwR) repo. 

Sidebar icons used throughout the book are credited to [Vector Markets](https://www.flaticon.com/authors/vectors-market) (lightbulb) and [Freepik](https://www.freepik.com") (notepad and caution sign) on [www.flaticon.com](https://www.flaticon.com/). All other images are my own and made with either [Excalidraw](https://excalidraw.com/) or [Inkscape](https://inkscape.org/).
