...
The datasaurus dozen [@datasaurus] and the `datasauRus` R package [@R-datasauRus]
...
## Misc - Deciding where this goes (TODO)

### Unobservable (censored) data
...
but we only observe it at a given point in time
...
mean(times[times < current_time])

# use current time for 
mean(pmax(times, current_time))
```
